...
- GitHub Actions: `.github/workflows/package-publish.yml` validates package build/stage/pack/consumer behavior for pull requests and publishes staged packages to GitHub Packages on main/tag push events using scoped npm registry configuration for `@signicode`.
