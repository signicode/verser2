...
- Keep transport-specific options grouped and optional, especially for HTTP/3 features that may vary by runtime.
...
- Treat HTTP/2 as the stable default for the MVP.
