...
- **Helpers:** `createGuestId`, `createPeerId`, `createRoutedDomainRegistration`,
  `resolveRouteForHostname`, `resolveRouteForUrl`, Broker request creation,
  registration/control-frame helpers, envelope readers/writers, error-response
...
- **Types:** peer/guest/request IDs, routed domain/request/response envelopes,
  ...
  registration authorization shapes, Broker routes control frames, TLS option
  shapes, error context/code shapes
